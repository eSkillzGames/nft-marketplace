...
function HomePage() {
  ...
  //       method: "post",
  //       url: API_URL + "/sendTransaction/v1/getAdminWallet",
  //       data: {},
  //       headers: {
  ...
  //       setAdminWallet(res.data.wallet);
  //     }
  //   } catch(er) {
  //     console.log(er);
  //   }
  ...
  const getAllCollections = async () => {
    ...
    try {
      const res = await axios({
        method: "post",
        url: API_URL + "/api/v1/getCollections",
        data: {},
        headers: {
          "Content-Type": `application/json`,
        },
    ...
    <div style={{ backgroundColor: '#072b36', padding: "20px" }}>
        ...
        {collectionData.length > 0 && (
          ...
          >
            {collectionData.map((e, ci) => {
              return <MenuItem style={{ display: "grid" }} value={ci}>{e.name}</MenuItem>;
            })}
          </Select>
        )}
        <div
      ...
      <div className={classes.hero}>
        ...
        {curCollection != null && curCollection.name == "Card" && (
          <Cards check={byAndSellSelected} sortVal={sortValue} collection={curCollection} adminwallet={adminWallet} />
        )}
        {curCollection != null && curCollection.name == "Cue" && (
          <Cues check={byAndSellSelected} sortVal={sortValue} collection={curCollection} adminwallet={adminWallet} />
        )}
        {curCollection != null && curCollection.name != "Cue" && curCollection.name != "Card" && (
          <GeneralNFTs check={byAndSellSelected} sortVal={sortValue} collection={curCollection} adminwallet={adminWallet} />
        )}
